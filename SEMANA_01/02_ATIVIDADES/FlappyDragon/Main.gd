...
var y = 1.5 # Variavel Y é o plano das coordenadas, que acaba sendo o controle para que o dragão possa subir ou descer no meio do plano cartesiano de acordo com o input dado ao computador.
